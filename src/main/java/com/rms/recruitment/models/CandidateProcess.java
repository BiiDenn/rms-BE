...
public class CandidateProcess {
    ...
    @OneToMany(mappedBy = "candidateProcess", cascade = CascadeType.ALL, fetch = FetchType.LAZY)
    private List<PhoneItvEval> phoneItvEvals;
    ...
    public List<PhoneItvEval> getPhoneItvEvals() {
        return phoneItvEvals;
    }

    public void setPhoneItvEvals(List<PhoneItvEval> phoneItvEvals) {
    ...
    public static class Builder {
        ...
        public Builder phoneItvEvals(List<PhoneItvEval> phoneItvEvals) {
            this.phoneItvEvals = phoneItvEvals;
            return this;
        }
